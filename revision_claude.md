...
5. ~~**Eliminar la duplicación literal** entre el test embebido de cada tema y `07_tests/test_tema_XX.md`~~ — **Hecho en esta rama** para los 15 temas de Bloque I: los 15 eran copia literal, todos sustituidos por un banco nuevo de 30 preguntas con distribución de letras equilibrada, sin tocar el test embebido. Pendiente: temas 20 y 21 de Bloque II, que también eran copia literal (se corrigió el sesgo en ambas copias pero no se ha eliminado aún la duplicación en sí).
