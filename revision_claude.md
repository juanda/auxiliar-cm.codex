...
- Temas Bloque I ya balanceados y sin tocar: 1, 3, 4, 6, 8, 11. Bloque II ya balanceados: 16, 17, 18, 19. `test_bloque_I.md`, `test_bloque_II.md` (fuera de la P.24) y el resto de tests psicotécnicos no mostraban sesgo severo y se dejaron igual.

No se ha abordado en esta pasada: eliminar la duplicación literal entre test embebido y `07_tests/` (Hallazgo 3), reforzar Excel/Power BI, crear flashcards de Bloque II, ni el resto de recomendaciones — quedan como trabajo pendiente descrito más abajo.
...
3. **Crear flashcards de Bloque II** (16-21) — pieza de mayor rentabilidad esperada específicamente para mejorar el resultado en informática, y hoy inexistente.
