# Tema 20. Outlook - Esquema de repaso

## Version oficial

La convocatoria 2026 fija `Microsoft 365 version escritorio` para Microsoft Office. Outlook debe estudiarse como Outlook de escritorio. Las preguntas historicas de Outlook 2016 se conservan como referencia de recurrencia, no como version oficial.

## Nucleo del tema

| Concepto | Definicion breve |
| --- | --- |
| Outlook | Aplicacion de Microsoft 365 para correo, calendario y contactos. |
| Correo | Envio, recepcion, respuesta, reenvio y organizacion de mensajes. |
| Calendario | Agenda para citas, reuniones y convocatorias. |
| Contactos | Libreta de direcciones, personas y listas de contactos. |
...
| Id | Idea |
| --- | --- |
| `2023-E2-001` | `Nuevo mensaje de correo electronico` esta en `Inicio` en Outlook clasico. |
| `2023-E2-005` | Conversacion = mensajes con el mismo asunto. |
| `2023-E2-015` | Marcas de seguimiento: enviados y recibidos. |
| `2023-E2-028` | Responder no incluye adjuntos; reenviar normalmente si. |
| `2023-E2-034` | `CCO` = con copia oculta. |
...
| Accion | Idea |
| --- | --- |
| Enviar | Remite el mensaje a los destinatarios. |
| Recibir | Entrada o sincronizacion de mensajes nuevos. |
...
| Borradores | Mensajes redactados y no enviados. |
| Elementos enviados | Mensajes ya enviados. |
| Elementos eliminados | Mensajes borrados. |
| Correo no deseado | Spam o mensajes sospechosos. |
| Archivo | Mensajes conservados fuera de entrada. |

## Reglas de mensaje

Una regla automatiza acciones sobre mensajes.
