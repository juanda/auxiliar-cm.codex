...
| Necesidad | Ruta/comando |
| --- | --- |
| Guardar con otro nombre | `Guardar como` |
| Recuperar Autoguardado | `Archivo` -> `Información` -> `Administrar documento` |
...
- En comodines, `!` dentro de corchetes excluye caracteres.
