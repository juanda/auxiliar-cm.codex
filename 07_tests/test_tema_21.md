...
2. Trabajar en Microsoft 365 sin conexion sobre archivos ya sincronizados significa que:
   ...
   B. Solo puede hacerse desde el navegador
   C. Los cambios se sincronizan al recuperar conexion
   D. Es imposible editar nada

3. Un equipo de Teams se define principalmente como:
   A. Una carpeta compartida temporal
   B. Un conjunto de personas, contenido y herramientas para colaborar
   C. Un chat puntual entre dos usuarios
   D. Un tipo de archivo de SharePoint

4. Dentro de un equipo de Teams, los canales sirven para:
   A. Cifrar automaticamente los documentos
   B. Sustituir el calendario de Outlook
   C. Crear bases de datos de Access
   D. Organizar conversaciones y archivos por temas o proyectos
...
14. Una biblioteca de documentos de SharePoint se diferencia de una lista en que:
    A. La lista almacena archivos y la biblioteca almacena datos
    B. Son exactamente lo mismo
    C. La biblioteca almacena archivos; la lista almacena datos estructurados en filas y columnas
...
16. Compartir un documento de SharePoint con permiso Puede ver implica que el destinatario:
    ...
    B. Se convierte en propietario
    C. Puede eliminar versiones anteriores
    D. Puede leerlo, pero no editarlo

17. La coautoria en Microsoft 365 consiste en:
...
18. El historial de versiones de un documento en SharePoint u OneDrive permite:
    ...
    B. Cambiar los permisos de todo el sitio
    C. Crear un canal nuevo en Teams
    D. Sustituir la coautoria

19. OneDrive permite principalmente:
    A. Crear equipos de Teams
    B. Sustituir el protocolo HTTPS
...
30. La diferencia principal entre FTP y SFTP es que:
...
| 5 | A | Un canal privado es accesible solo para un subconjunto de miembros. |
| 6 | C | El chat es directo o de grupo; el canal organiza el trabajo del equipo. |
