...
2. "Que no admite duda" significa:
   A. Inefable.
   B. Indubitado.
   C. Inmarcesible.
   D. Vituperado.

3. Derogar es a vigencia como absolver es a:
   A. Responsabilidad.
   B. Demanda.
   C. Condena.
   D. Recurso.

4. El antonimo mas preciso de "prolijo" es:
   A. Minucioso.
   B. Extenso.
   C. Conciso.
   D. Confuso.
...
6. Recto es a torcido como afable es a:
   A. Cordial.
   B. Desagradable.
   C. Cercano.
   D. Amable.

7. Indique cuantas palabras contienen error ortografico, sin valorar tildes: exhalar, exhuberante, hincar, umbral, desahucio, exibir, hostil, alhaja, inhibir, reusar.
   A. 1
   B. 2
   C. 3
   D. 4

8. "Egresar" es a "ingresar" como "escindir" es a:
   A. Cohesionar.
   B. Dividir.
   C. Separar.
   D. Extraer.

9. El sinonimo mas adecuado de "loable" es:
   A. Reprobable.
   B. Laudable.
   C. Dudoso.
   D. Fragil.
...
10. Indique la opción que contiene antonimos, en el mismo orden, de: apacible / flamante / extremado.
    ...
    D. Agitado / reciente / radical.

11. Mesura es a desmesura como inmediatez es a:
    A. Tardanza.
    B. Proximidad.
    C. Rapidez.
    D. Presencia.

12. "Expeler" significa:
    A. Absorber.
    B. Expulsar.
    C. Retener.
    D. Atraer.

13. Indique cuantas palabras contienen error ortografico, sin valorar tildes: zanahoria, biznieto, hervir, subrrayar, convalecencia, escasez, alcol, travesia, oveja, extrangero.
    A. 2
    B. 3
    C. 4
    D. 5

14. Encontrar es a perder como estorbar es a:
    A. Facilitar.
    B. Impedir.
    C. Molestar.
    D. Desviar.

15. El sinonimo mas adecuado de "recalcitrante" es:
    A. Flexible.
    B. Obstinado.
    C. Fugaz.
    D. Incauto.
...
| 15 | B | `Recalcitrante` alude a quien se mantiene obstinado o terco. |
